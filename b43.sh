...
sudo apt-get install flex bison debhelper wget # build-essential
...
## sudo cp $FWDIR_PROP/ht0initvals29.fw    /lib/firmware/b43-open/
## sudo cp $FWDIR_PROP/ht0bsinitvals29.fw  /lib/firmware/b43-open/
## sudo cp $FWDIR_PROP/ucode29_mimo.fw     /lib/firmware/b43-open/
